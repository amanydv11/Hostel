    ...
    <div className="p-4">
      ...
      <div className="container mx-auto max-w-5xl mt-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {[{ img: stay, text: "Finding a stay that's right for you", link:"#" },
            { img: cancel, text: "Retired article 3122: How cancellations work",link:"#" },
            { img: setupaccount, text: "Setting up your account",link:"#" },
            { img: hostel, text: "HostelCover for guests",link:"#" }]
      ...
      <div className="container mx-auto max-w-5xl mt-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            { title: "Check your reservation status as a guest", desc: "Your reservation status keeps you updated on all kinds of things, such as whether you’re...",link:"#" },
            { title: "Deactivating or deleting your account", desc: "We’d hate to see you go, but if you’ve decided to leave Airbnb, you have a couple of options...",link:"#" },
            { title: "Verify your phone number", desc: "Let’s connect! Make sure that the right people have your correct phone number. Hosts need...",link:"#" },
            { title: "Editing a review you wrote", desc: "To encourage honest and impartial reviews, we...",link:"#" },
            { title: "Instant Book", desc: "Want to book a place right away? Try...",link:"#" },
      ...
      <div className="bg-black text-white flex flex-col items-center py-10 mt-10">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {[{ img: policy, title: "Our community policies", desc: "How we build a foundation of trust.",link:"#" },
            { img: safety, title: "Safety tips and guidelines", desc: "Resources to help travellers stay safe.",link:"#" }]
